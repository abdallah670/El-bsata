...
@Component({
  ...
  template: `
    ...
    <p style="font-size: 0.85rem; color: #d6d3d1; margin-bottom: 1rem;">
      ...
      <footer class="footer">
        <p style="font-weight: 700; color: #a8a29e;">مطعم ومسمط البساطة لفواكة اللحمة وسندوتشات الكبدة والمخاصي  والكوارع</p>
        <p>© {{ currentYear }} - جميع الحقوق محفوظة لجهة الطلب والمسجلة في جمهورية مصر العربية</p>
        <p style="font-size: 0.65rem; margin-top: 0.5rem;">تم تهيئة هذا النظام بالكامل لخدمة الطلب السريع بالبريد الإلكتروني والموقع الجغرافي للعملاء.</p>
      </footer>
